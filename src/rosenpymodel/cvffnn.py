...
class CVFFNN(rpnn.NeuralNetwork): 
    """
    ...
    def feedforward(self, x):
        ...
        self.layers[0]._activ_out = self.layers[0].activation(self.layers[0]._activ_in, derivative=False)
        ...
        for i in range(1, len(self.layers)):
            ...
            # Apply activation function to the output of the current layer
            self.layers[i]._activ_out = self.layers[i].activation(self.layers[i]._activ_in, derivative=False)
    ...
    def backprop(self, y, y_pred, epoch):
        ...
        for layer in reversed(self.layers):
            ...
            deriv = layer.activation(layer._activ_in, derivative=True)
